...
log_file_path = '/opt/do_prometheus_metrics/check_status.log'
...
def check_druid_health():
    ...
    try:
        ...
        print("Error in get_app_status: {}".format(e))  # Using format()
        return 0
...
if __name__ == "__main__":
    ...
    config = load_configuration('/opt/do_prometheus_metrics/conf.json')
    ...
    try:
        with open('/opt/do_prometheus_metrics/status.json', 'w') as json_file:
